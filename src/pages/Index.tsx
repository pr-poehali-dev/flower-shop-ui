        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-primary flex items-center gap-2">
              <span className="text-3xl">🌸</span> FleurBoutique
            </h1>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Создаём настроение каждый день. Доставка по Москве за 2 часа
              </p>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-pink max-w-none">
              <p className="text-lg mb-4">
                FleurBoutique — это команда профессиональных флористов с 10-летним опытом. 
                Мы создаём уникальные букеты, которые дарят радость и особенные эмоции.
              </p>
              <p className="text-lg mb-4">
